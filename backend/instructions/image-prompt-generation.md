...
- A concrete non-photographic medium anchor with an established visual identity of its own — e.g. "next-gen video game cinematic character render," "concept-art digital painting with photographic lighting," "CG character render in the style of an animated feature's realistic character model." Avoid vague labels like "hyper-detailed render" alone — they carry no visible signal and the image will still read as a photo.
...
**Output**:
Character reference sheet — two-panel side-by-side layout on a plain light neutral background, wide landscape format (16:9). Left panel: close-up portrait from mid-chest upward of a woman in her mid-20s with an invented, original appearance — sharp cheekbones, straight dark hair pulled into a neat ponytail, athletic build, and a determined, focused expression, gaze slightly angled toward camera. Right panel: full-body view of the same woman in a natural standing pose, wearing a fitted grey running jacket over dark athletic leggings, full outfit and proportions visible head to toe, same lighting and same expression. Rendered as a next-gen video game cinematic character render — concept-art quality digital painting with photographic-grade lighting and rich, cinematic detail. Skin is rendered with smooth, slightly idealized digital-painting texture, with no individually rendered pores or photographic skin-scan detail. No camera artifacts of any kind: no depth-of-field blur, no lens flare, no chromatic aberration, no film grain. Clean, even studio-quality lighting with soft falloff, no dramatic shadows obscuring the face. Plain light neutral background in both panels.
