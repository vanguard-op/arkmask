...
# (sourced from GCP_PROJECT_ID secret and GCP_GITHUB_REPO variable in GitHub Actions).
# db_password is injected via TF_VAR_db_password (sourced from TF_VAR_DB_PASSWORD secret).
#
